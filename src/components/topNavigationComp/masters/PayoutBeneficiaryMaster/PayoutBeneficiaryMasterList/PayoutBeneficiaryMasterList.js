                    ...
                    <div className="card">
                        <div className="card-header pb-0">
                            <div className="d-flex justify-content-between">
                                <h4 className="card-title mg-b-2 mt-2">Payout Beneficiary Master</h4>

                                <Link to="/add-payout-beneficiary-master" className="btn btn-danger btn-sm">Add Payout Beneficiary Master</Link>
                                            ...
                                            <table className="table-all">
                                                ...
                                                <tbody>
                                                    <tr role="row" class="odd border-top border-bottom border-primary">
                                                        ...
                                                        <td>Date</td>
                                                        <td>9976744364</td>
                                                        <td>64569976744364</td>
                                                        <td>Gita</td>
                                                        <td>SBI001234</td>

                                                        <td>
                                                            <span className='bg-warning  py-1 px-2 rounded'><Link to={"/update-payout-beneficiary-master"} className='text-light text-decoration-none'><FaRegEdit className='FaRegEdit' />Edit</Link></span>
                                                        </td>
                                                    </tr>
