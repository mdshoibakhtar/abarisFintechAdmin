                    ...
                    <div className="card">
                        <div className="card-header pb-0">
                            <div className="d-flex justify-content-between">
                                <h4 className="card-title mg-b-2 mt-2">Agent Onboarding List</h4>

                                <Link to="" className="btn btn-primary btn-sm">Download Agent List</Link>

                                <Link to="/add-agent-onboarding" className="btn btn-danger btn-sm">Add Agent Onboarding</Link>
                                            ...
                                            <table className="table-all">
                                                ...
                                                <tbody>
                                                    <tr role="row" class="odd border-top border-bottom border-primary">
                                                        ...
                                                        <td>
                                                            <span className='bg-warning  py-1 px-2 rounded'><Link to={"/update-agent-onboarding"} className='text-light text-decoration-none'><FaRegEdit className='FaRegEdit' />Edit</Link></span>
                                                        </td>
                                                    </tr>
