                    ...
                    <div className="card">
                        <div className="card-header pb-0">
                            <div className="d-flex justify-content-between">
                                <h4 className="card-title mg-b-2 mt-2">Payment Method</h4>

                                <Link to="/add-payment-method" className="btn btn-danger btn-sm">Add Payment Method </Link>
                                            ...
                                            <table className="table-all">
                                                ...
                                                <tbody>
                                                    <tr role="row" class="odd border-top border-bottom border-primary">
                                                        <td> 1</td>
                                                        <td>Date</td>
                                                        <td class="sorting_1">Cash Payment</td>


                                                        <td>
                                                            <span className='bg-success text-light py-1 px-2 rounded'>Success</span>
                                                        </td>
                                                        <td>
                                                            <span className='bg-warning  py-1 px-2 rounded'><Link to={"/update-payment-method"} className='text-light text-decoration-none'><FaRegEdit className='FaRegEdit' />Edit</Link></span>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr role="row" class="odd border-top border-bottom border-primary">
                                                        ...
                                                        <td>
                                                            <span className='bg-danger text-light py-1 px-2 rounded'>Success</span>
                                                        </td>
                                                        <td>
                                                            <span className='bg-warning  py-1 px-2 rounded'><Link to={"/update-payment-method"} className='text-light text-decoration-none'><FaRegEdit className='FaRegEdit' />Edit</Link></span>
                                                        </td>
